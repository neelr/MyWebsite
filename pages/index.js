    ...
    render() {
        return (
            <Layout>
                ...
                <ul>
                    <li>Was one of the head tech organizers for <a style={{ color: "yellow" }} href="https://summer.hackclub.com/">Summer of Making</a>, where students from across the world created amazing projects, and we recieved 50K in funding from GitHub to spread the love of hardware to many people, during the pandemic. It started with me and a few of my friends, but eventually grew to the entire Hack Club community, where we started to host AMA's, display art, and so many cool things. Overall, we sent hardware to 129 countries and helped teens across the world start their journey as makers.</li>
                    <li>Organized <a style={{ color: "yellow" }} href="https://angelhacks.org">AngelHacks LA</a> as a Director of Tech (A great experience overall, <a href="https://notebook.neelr.dev/stories/angelhacks">check it out on my notebook!</a>), and many more including <a href="https://dvhacks.tech">DVHacks</a>,  <a href="https://hacknewyear.com/">Hack the New Year</a>,  <a href="https://www.codeday.org/">Code Day Bay Area</a>, and  <a href="https://hackthefog.com/">Hack the Fog</a>!</li>
                    <li>Attended <a style={{ color: "red" }} href="https://flagshipsummit.com">Flagship Summit</a>, a youth leadership conference where I got to learn more about teaching people, organizing hackathons, and gaining sponsors! I also met cool people that helped me a lot like <a href="https://lachlanjc.me">@lachlanjc</a>, <a href="https://zachlatta.com/">@zrl</a>, and <a href="https://tom.preston-werner.com/">@mojombo.</a> Read more <a href="https://notebook.neelr.dev/stories/Xq6TDBEAACUAl2NV">in my notebook</a>!</li>
