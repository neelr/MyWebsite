...
import { getLocation, Data as locationType } from "../pages/api/getLocation";
import { getQuote, Data as quoteType } from "../pages/api/quote";
        ...
        <Emotion>
            <Box sx={{ display: "flex", mt: ["0px", "100px"], flexDirection: ["column", "row"] }}>
                ...
                >
                    ...
                    <Box>
                        <I src={"/hippo.png"} width={200} height={200} alt="hippo" />
                    </Box>
                </Box>
            </Box >
        </Emotion>
